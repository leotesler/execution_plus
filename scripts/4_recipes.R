...
# load data ----
load(here("scripts/samples/pitch_train.rda"))
load(here("scripts/results/var_select_lasso.rda"))
...
main_sink_rec <- recipe(run_exp_above_avg ~ ., pitch_train) |> 
  step_rm(pitch_name, player_name, pitcher, inning_topbot, game_date, batter, des, game_type) |> 
...
# save results ----
dir.create("scripts/recipes")

save(main_sink_rec, file = here("scripts/recipes/main_sink_rec.rda"))
save(main_feat_rec, file = here("scripts/recipes/main_feat_rec.rda"))
save(tree_sink_rec, file = here("scripts/recipes/tree_sink_rec.rda"))
save(tree_feat_rec, file = here("scripts/recipes/tree_feat_rec.rda"))
