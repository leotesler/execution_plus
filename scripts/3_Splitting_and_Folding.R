...
# load data ----
pitch_data <- read_rds("scripts/data/pitch_data.rds")
...
# save results
dir.create("scripts/samples")

save(pitch_train, file = "scripts/samples/pitch_train.rda")
save(pitch_test, file = "scripts/samples/pitch_test.rda")
save(pitch_folds, file = "scripts/samples/pitch_folds.rda")
