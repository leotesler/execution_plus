...
# load data ----
savant_data <- read_csv("scripts/data/savant_data_25.csv") |> 
...
pitch_data <- pitch_data |> 
  ...
  select(release_spin_rate, spin_axis, 
         ...
         post_away_score, player_name, pitcher, pitch_number, outs_when_up,
...
write_rds(pitch_data, "scripts/data/pitch_data.rds")
